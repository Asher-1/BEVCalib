...
# Supports multiple datasets with organized log structure
# 
# Usage:
...
#
# Examples:
#   # Train on B26A dataset
#   bash train_universal.sh scratch --dataset_root /path/to/bevcalib_training_data --dataset_name B26A
#
#   # Train on all_training_data dataset
#   bash train_universal.sh scratch --dataset_root /path/to/all_training_data --dataset_name all_training_data
#
#   # Train multiple datasets in parallel
#   bash train_universal.sh scratch --cuda_device 0 --dataset_root /path/to/dataset1 --dataset_name dataset1
#   bash train_universal.sh scratch --cuda_device 1 --dataset_root /path/to/dataset2 --dataset_name dataset2
#
#   # Train with different perturbation settings (based on paper)
#   # Small perturbation (10°, 0.5m) - for fine calibration
#   bash train_universal.sh scratch --dataset_root /path/to/data --dataset_name mydata --angle_range_deg 10 --trans_range 0.5 --log_suffix small_10deg
#   # Medium perturbation (15°, 1.0m)
#   bash train_universal.sh scratch --dataset_root /path/to/data --dataset_name mydata --angle_range_deg 15 --trans_range 1.0 --log_suffix medium_15deg
#   # Large perturbation (20°, 1.5m) - default, for initial calibration
#   bash train_universal.sh scratch --dataset_root /path/to/data --dataset_name mydata --angle_range_deg 20 --trans_range 1.5 --log_suffix large_20deg
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Available options: --dataset_root, --dataset_name, --cuda_device, --tensorboard_port, --log_suffix, --angle_range_deg, --trans_range"
            exit 1
            ;;
    esac
done
