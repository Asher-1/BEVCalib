...
OPTIM_PARAMS = [
    ...
    ('val_holdout_sequences', '--val_holdout_sequences'),
    ('rotation_target_definition', '--rotation_target_definition'),
    ...
    ('jacobian_loss_axis_weights', '--jacobian_loss_axis_weights'),
    ...
    ('dual_gate_signed_slope_min', '--dual_gate_signed_slope_min'),
    ...
    ('seq_weight_overrides', '--seq_weight_overrides'),
    ('wd', '--wd'),
    ('optimizer', '--optimizer'),
    ...
    ('paper_feat_dim', '--paper_feat_dim'),
    ('paper_n_groups', '--paper_n_groups'),
    ('paper_knn', '--paper_knn'),
    ('paper_sim_layers', '--paper_sim_layers'),
    ('paper_depth_bins', '--paper_depth_bins'),
    ('paper_sim_loss_weight', '--paper_sim_loss_weight'),
    ('paper_fov_loss_weight', '--paper_fov_loss_weight'),
    ('paper_coarse_loss_weight', '--paper_coarse_loss_weight'),
    ('use_rocr', '--use_rocr'),
    ...
    ('medw_early_stop_patience', '--medw_early_stop_patience'),
    ('medw_early_stop_min_delta_deg', '--medw_early_stop_min_delta_deg'),
    ...
    ('enable_gnc_loss', '--enable_gnc_loss'),
    ('gnc_mu_start_deg', '--gnc_mu_start_deg'),
    ('gnc_mu_end_deg', '--gnc_mu_end_deg'),
    ('gnc_mu_start', '--gnc_mu_start'),
    ('gnc_mu_end', '--gnc_mu_end'),
    ('gnc_noise_bound_deg', '--gnc_noise_bound_deg'),
    ('gnc_use_irls', '--gnc_use_irls'),
    ('gnc_mu_adaptive_init', '--gnc_mu_adaptive_init'),
    ('gnc_factor', '--gnc_factor'),
    ('gnc_mu_cap', '--gnc_mu_cap'),
    ('gnc_schedule', '--gnc_schedule'),
    ('gnc_anneal_epochs', '--gnc_anneal_epochs'),
    ('gnc_start_epoch', '--gnc_start_epoch'),
    ('gnc_on_paper_rotation', '--gnc_on_paper_rotation'),
    ('gnc_on_inject_recovery', '--gnc_on_inject_recovery'),
    ('gnc_axis_weights', '--gnc_axis_weights'),
    ('use_mgda', '--use_mgda'),
    ('mgda_start_epoch', '--mgda_start_epoch'),
    ('mgda_include_inject', '--mgda_include_inject'),
    ('mgda_include_photo', '--mgda_include_photo'),
    # V54: LSP + RigC + PRS
    ('use_lsp_loss', '--use_lsp_loss'),
    ('lsp_weight', '--lsp_weight'),
    ('lsp_weight_start', '--lsp_weight_start'),
    ('lsp_ramp_epochs', '--lsp_ramp_epochs'),
    ('lsp_start_epoch', '--lsp_start_epoch'),
    ('lsp_lambda_ssim', '--lsp_lambda_ssim'),
    ('lsp_max_points', '--lsp_max_points'),
    ('lsp_downsample', '--lsp_downsample'),
    ('lsp_loss_clip', '--lsp_loss_clip'),
    ('lsp_min_valid_ratio', '--lsp_min_valid_ratio'),
    ('rig_consistency_weight', '--rig_consistency_weight'),
    ('rig_consistency_start_epoch', '--rig_consistency_start_epoch'),
    ('pose_release_epoch', '--pose_release_epoch'),
    ('pose_release_joint_epoch', '--pose_release_joint_epoch'),
    ('pose_release_corr_lr_scale_joint', '--pose_release_corr_lr_scale_joint'),
    ...
    ('route_zd_penalty_weight', '--route_zd_penalty_weight'),
    ('dp_route_input_mode', '--dp_route_input_mode'),
    ('dp_jacg_input_mode', '--dp_jacg_input_mode'),
    ('dp_recovery_quat_loss_weight', '--dp_recovery_quat_loss_weight'),
    ('dp_train_hard_route', '--dp_train_hard_route'),
    ('use_jacg', '--use_jacg'),
    ...
    ('adir_train_only', '--adir_train_only'),
