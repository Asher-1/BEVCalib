...
CKPT="${2:-logs/all_training_data/model_small_5deg_v80_tinit_bev_film_rpy02_smoke/all_training_data_scratch/checkpoint/ckpt_best_dual.pth}"
LABEL="${LABEL:-v80_tinit_bev_film_rpy02}"

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PY="${PY:-/opt/conda/envs/bevcalib310/bin/python}"
GPU="${GPU:-0}"
DATA="${DATA:-/mnt/drtraining/user/dahailu/data/bevcalib/test_data_v2}"
OUT_ROOT="${OUT_ROOT:-${ROOT}/logs/evaluations/v80_tinit_bev_film_rpy02/${LABEL}}"
...
echo "V80 RPY<${RPY_THRESHOLD_DEG} eval output: ${OUT_DIR}"
