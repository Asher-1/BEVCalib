#!/bin/bash
# V55 泛化评估 + deploy gate 验收
#
# 用法:
#   bash run_v55_eval.sh --precheck-only
#   bash run_v55_eval.sh --gate-eval
#   nohup bash run_v55_eval.sh --gate-eval > logs/evaluations/generalization_v55/nohup.log 2>&1 &
...
EVAL_CONFIG="configs/eval_generalization_v55.yaml"
LOG_DIR="logs/evaluations/generalization_v55"
GATE_LABEL="v55-main-gate"
mkdir -p "$LOG_DIR"

echo "========================================"
echo "V55 Generalization Evaluation"
...
cfg = yaml.safe_load(open("configs/eval_generalization_v55.yaml"))
